...
def main():
    ...
    parser.add_argument(
        "--output-name", type=str, default="train_data", help="Name for output file"
    )
    parser.add_argument(
        "--method",
        type=str,
    ...
    parser.add_argument(
        "--depth", type=int, default=20, help="Stockfish analysis depth"
    )
    parser.add_argument(
        "--threads", type=int, default=4, help="Number of Stockfish threads"
    )
    parser.add_argument(
        "--no-bad-moves", action="store_true", help="Don't include bad move examples"
    )
