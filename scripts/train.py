...
from ochess.utils import create_model, get_available_device
...
def main():
    ...
    # Data
    parser.add_argument(
        "--data", type=str, required=True, help="Path to training data (parquet)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--hidden-dim", type=int, default=256, help="Hidden dimension size"
    )
    parser.add_argument(
        "--num-blocks",
        type=int,
    ...
    dataset = ChessDataset(args.data, sequence_length=args.sequence_length)
